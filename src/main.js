import { fetchData, ingridientAndMeasureData, splitInstructions } from './utils/functions';
import { clear, paragraphElement, listElement, orderListElement, imageElement } from './utils/items';
